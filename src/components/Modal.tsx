  ...
  const modalContent = (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-3xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-hidden border border-gray-100">
        {/* Header */}
        <div className="flex flex-col p-6 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-purple-50 relative">
          ...
          <div className="flex items-center space-x-3 mb-1">
            ...
            <h3 className="text-xl font-bold text-gray-900">desabafo.app</h3>
          </div>
